...
class QueryExecutorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Count = channel.unary_unary(
                ...
                request_serializer=chromadb_dot_proto_dot_chroma__pb2.CountPlan.SerializeToString,
                response_deserializer=chromadb_dot_proto_dot_chroma__pb2.CountResult.FromString,
                )
        self.Get = channel.unary_unary(
                '/chroma.QueryExecutor/Get',
                request_serializer=chromadb_dot_proto_dot_chroma__pb2.GetPlan.SerializeToString,
                response_deserializer=chromadb_dot_proto_dot_chroma__pb2.GetResult.FromString,
                )
...
def add_QueryExecutorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Count': grpc.unary_unary_rpc_method_handler(
                    servicer.Count,
                    request_deserializer=chromadb_dot_proto_dot_chroma__pb2.CountPlan.FromString,
                    response_serializer=chromadb_dot_proto_dot_chroma__pb2.CountResult.SerializeToString,
            ),
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=chromadb_dot_proto_dot_chroma__pb2.GetPlan.FromString,
                    response_serializer=chromadb_dot_proto_dot_chroma__pb2.GetResult.SerializeToString,
            ),
...
class QueryExecutor(object):
    ...
    def Count(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/chroma.QueryExecutor/Count',
            chromadb_dot_proto_dot_chroma__pb2.CountPlan.SerializeToString,
            chromadb_dot_proto_dot_chroma__pb2.CountResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/chroma.QueryExecutor/Get',
            chromadb_dot_proto_dot_chroma__pb2.GetPlan.SerializeToString,
            chromadb_dot_proto_dot_chroma__pb2.GetResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
